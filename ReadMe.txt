...
│   ├── init_ollama.sh      # Script to initialize Ollama models
│   └── start_backend.sh    # Script to launch the backend service
├── src/
...
(Alternatively, run ./scripts/init_ollama.sh if provided)
